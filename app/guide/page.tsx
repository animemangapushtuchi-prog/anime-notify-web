  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-6">
      ...
      <div className="mt-4 space-y-3">
        <Section title="① はじめかた">
          <p>
            メール登録なしでも、作品詳細で「通知登録」を押すだけで5作品までゲスト利用できます。
            メール登録すると登録枠が10件になり、ログインボーナス（1日+1件・最大+5件）で最大15件まで増えます。
            ゲストから始めた場合も、メール登録でデータをそのまま引き継げます。端末を変えて使うにはメール登録が必要です。
          </p>
        </Section>
        ...
        <Section title="② マイリスト">
          <p>
            ...
            右上のソートで並び替え、「編集」で解除ができます（登録枠：ゲスト5件／メール登録10件〜最大15件）。
          </p>
        </Section>
